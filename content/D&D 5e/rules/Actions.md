...
The time it takes to don or doff armor [depends on the armor's category](getting-into-and-out-of-armor-donning-and-doffing-armor.md). A [shield](5.D&D%205e/compendium/items/shield.md) can be donned or doffed as an action.
